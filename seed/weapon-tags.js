module.exports = [
  ...
  "Blood Hound: Upon successful hit, the wielder of this weapon will know the distance & direction of the target for the next 'x' hours.",
  "Boreal: If laid on the ground the weapon will turn to point North. Also, if used to 'attack' the air it can increase or decrease local windspeed by 1 mph for every HP of damage it would have dealt. This doesn't work if there couldn't naturally be wind in the area (e.g. in most dungeons).",
