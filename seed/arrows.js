module.exports = [
  ...
  "Non-lethal Arrows (blunt head) (2) - does blunt instead of piercing damage.",
  "Grappling Arrow (10) - Arrow with a strong head that will hold up to 300 lbs of weight on an attached 100ft length of rope.",
  "Water Arrow (3) - When this arrow makes contact, it releases a burst of water that extinguishes any source of fire no greater than a five foot cube.",
  "Rope Arrow (3) - When fired, this arrow releases 25 feet of hempen rope behind it.",
  "Arrow of Healing (5) - Deals 1d4 damage, heals 1d8 hp.",
  "Flare Arrow (5) - creates a flare-like projectile. If shot skyward, can be seen up to one mile away. Only does 1d4 additional fire damage.",
  "Wyrmslayer Arrow (5) - Deals double damage to dragons and like kin.",
  "Compass Arrow (3) - Ordinary when fired but swivels to point north when balanced on a finger.",
  "Quiver Mother Arrow (50) - As long as this arrow is in your quiver it makes 15 arrows per day.",
  "Blessed Arrow (5) - does extra 1d4 damage to undead.",
  "Smoke Bomb Arrow (2)",
  "Bola Arrow (1) - An arrow that releases a set of connected cords which wrap around a moving target in order to take them down. It is often used to tie the targets wrists, legs, and neck.",
  "Flashbang Arrow (2)",
  "Double Arrow (5) - The tip of the arrow splits in two when fired. Allowing for two targets to be hit, a wire can also be projected between the two arrowheads, similar to the bola arrow.",
  "Paint Arrows (2) - Guaranteed to turn target [various colors available] for 1d4 hours",
  ]
